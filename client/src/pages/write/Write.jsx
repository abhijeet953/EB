...
//Yha pe hum jo frontend me chage kr rhe hai usko properly achieve kr k liye Schema bhi alag se banana padega
...
export default function Write() {
  ...
  const func = () => {
    ...
    if (user.userCategory === "Organizer")
      return (<div className="write">
        ...
        <form className="writeForm" onSubmit={handleSubmit}>
          ...
          <div className="writeFormGroup">
            <textarea
              placeholder="Why one should take part in your event"
              type="text"
